...
public class Capitaldetails {
    ...
    private Float cdIncome;

    private Float cdExpenditure;
    ...
    public Float getCdIncome() {
        return cdIncome;
    }

    public void setCdIncome(Float cdIncome) {
        this.cdIncome = cdIncome;
    }

    public Float getCdExpenditure() {
        return cdExpenditure;
    }

    public void setCdExpenditure(Float cdExpenditure) {
